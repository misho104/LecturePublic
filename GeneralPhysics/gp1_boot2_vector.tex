...
\begin{miniitemize}
  \item \strikeThrough{clockwise}counterclockwise as viewed from $+x$ toward the origin,
\end{miniitemize}
...
\Remark{Later in General Physics lecture, you will learn that any 3d rotations can be described by vectors (called angular speed vectors). For a rotation with the angular speed vector $\vc \omega$, the direction of $\vc \omega$ describes the axis of the rotation (under the right-hand rule) and $|\vc \omega|$ is the angular speed $\dd\theta/\dd t$.}
...
\begin{enumerate}[resume]
 ...
 \Hint{You are asked to put your thought into English words.}
\end{problems}
