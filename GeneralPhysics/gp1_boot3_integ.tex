...
Therefore, Sho \emph{always} uses Mathematica or \hrefFN{https://www.wolframalpha.com/}{Wolfram Alpha} for integral calculations, and you can do so as well.
...
\end{menumerate}
\begin{quizzes}
  \Quiz[S]{Calculate the above derivatives (on $x$). Great attention is required for $(\ln\abs{x})'$.}
\end{quizzes}
