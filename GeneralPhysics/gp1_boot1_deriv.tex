...
In particular, notice that \Emph{the small circle $^\circ$ means ``degrees''}. If you write the small circle, it is equivalent to ``degrees''. Meanwhile, if you do not write the circle $^\circ$, we interpret it in radians. So,
\[
