...
\begin{problems}
  ...
  \end{menumerate}
  \itemS Let $f(x)=x^4$. Calculate $f'(x)$, $f'(c)$, $f'(0)$ and $f'(1)$.
\end{problems}
...
\begin{problems}
  \itemS Calculate the following values.
  \begin{menumerate}{4}
...
\itemS
  ...
  \begin{menumerate}{3}
    ...
    \DIFF{\left(4x\right)}
  \end{menumerate}
 \itemS We know that a function $f(x)$ satisfies an equation $f'(x)=4x$. Can you find what $f(x)$ is? If you can, find more than one.
\end{problems}
...
\begin{problems}
  ...
  \end{menumerate}
  \itemS Calculate the following derivatives, using Eqs.~\eqref{eq:reci}--\eqref{eq:quot}.
  \begin{menumerate}{3}
    \DIFF{(x+1)(x^2 + 2)}
    \DIFF{x  \sin x}
    \DIFF{(3x^2 + 2x + 1)^2}
...
\begin{problems}
\itemS Practice for the formulae~\eqref{eq:reci} and~\eqref{eq:prod}.
\begin{menumerate}{3}
  \DIFF{\frac{1}{\sin x}}
  \DIFF{\frac{1}{3x^2+1}}
  ...
  \DIFF{(x^2\cdot x^3)}
\end{menumerate}
\itemS Practice for the formulae~\eqref{eq:reci} and~\eqref{eq:quot}. Here, $n$ is a positive integer.
\begin{menumerate}{4}
  \DIFF{\frac{x+1}{x-1}}
  \DIFF{\frac{x+1}{x^2+1}}
  \DIFF{\frac{x^2-1}{x-1}}
...
\begin{problems}
\itemS Calculate the following derivatives based on the theorem above.
\begin{menumerate}{3}
  \DIFF{x^{64}}
  \DIFF{\sqrt x}
  \DIFF{x^{1/3}}
