...
\end{theorem}
\emph{In most of the simple cases}, the \Emph{general solution} of a first-order differential equation has one unknown constant $C$, and the general solution of second-order differential equation has two unknown constant $C_1$ and $C_2$.
