...
\Remark{Some suggestions may not apply to other instructors, particularly about the usage of Generative AI, or if the lecture is not in physical science. If unsure, ask your instructor and follow their rules.}
...
\begin{miniitemize}
  \item Clarity is the most important. Do not confuse readers.
...
Even though you need to check your answer before submission, you will not have the ``correct solutions.''
...
In other words, try to \emph{not be taught}, but please \emph{learn by yourselves}.
...
Since exercises usually have a single correct answer, working with others will help everyone.
...
You can also assume that Sho and the TA are colleagues.
...
In particular, make sure to define each term or symbol in your math, use consistent notation, provide captions and explanations for figures and tables, and explain your findings and thoughts step by step. ``Long but clear'' writings are far better than ``concise but confusing.''
...
% other remaks
% なお，問題の番外編として，今までの講義内容・講義形態についての感想，不満，文句，このように改善すべきとの意見などもできるだけ書いてください.お願いします。
