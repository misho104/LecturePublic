...
\end{itemize}
Sho also thinks that returning answer sheets will have no effect on improving their learning, while it consumes significant time of Sho, which should be used for other educational activities.
\begin{itemize}
...
\begin{itemize}
  \item Mini tests. Sho designs them as an opportunity to provide feedback, rather than as a means to evaluate achievement, so that they recognize shortcomings in their discussion and writing.
  ...
  \item During office hours. However, only if they rework an exam or test and produce their own revised answers. They need to have in-person visits.
\end{itemize}
